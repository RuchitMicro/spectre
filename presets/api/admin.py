...
try:
    ...
    DJANGO_JSON_EDITOR_AVAILABLE = True
except ImportError:
    DJANGO_JSON_EDITOR_AVAILABLE = False
    pass
...
class GenericAdmin(ModelAdmin):
    def __init__(self, model, admin_site):
        ...
        self.import_form_class  =   ImportForm
    ...
    def formfield_for_dbfield(self, db_field, request, **kwargs):
        ...
        if isinstance(db_field, models.JSONField) and self.admin_meta:
            ...
            if json_schema:
                ...
                kwargs['widget'] = JsonEditorWidget(schema=json_schema)       # Patch this later
            else:
                if DJANGO_JSON_EDITOR_AVAILABLE:
...
try:
    ...
    admin.site.register(User, GenericAdmin)
    admin.site.register(Group, GenericAdmin)
except:
    pass

# Register all the models in the specified app
